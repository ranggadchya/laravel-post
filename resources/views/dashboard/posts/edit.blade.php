  ...
  <form action="/dashboard/posts/{{ $post->slug }}" method="post" enctype="multipart/form-data">
    ...
    <div class="row g-3 mb-3">
      <div class="col-sm-6 form-floating">
        <input type="text" class="form-control fs-6 @error('title') is-invalid @enderror" id="title" name="title" placeholder="Your Title" required autofocus value="{{ old('title', $post->title) }}">
      ...
      <div class="col-sm-6 form-floating">
        <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" placeholder="Slug will automatically" readonly value="{{ old('slug', $post->slug) }}">
      ...
      <div class="col-sm-12">
        ...
        @if ($post->image)
          <img src="{{ asset('storage/' . $post->image) }}" class="img-preview img-fluid mb-2 col-sm-5 d-block" alt="">
        @else
